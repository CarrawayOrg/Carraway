...
import CurrentDrives from '../components/sections/CurrentDrives';
...
const Home = () => {
  ...
  return (
    ...
    justifyContent: 'center', marginTop: -75, marginBottom: 20}}>
                ...
                <div className="flex flex-wrap -m-4 text-center float-center" style = {{overflow: "hidden"}}>
                  <div className="w-1/3 p-4" style = {{float: "left"}}>
                    ...
                    <p className="leading-relaxed">Websites Made</p>
                  </div>
                  ...
                  <div className="w-1/3 p-4" style = {{float: "left", marginRight: 200, marginLeft: 200}}>
                    ...
                    <p className="leading-relaxed">Community Drives</p>
                  </div>

                  <div className="w-1/3 p-4" style = {{float: "left"}}>
                    <h2 className="text-4xl font-medium text-black title-font sm:text-5xl">
                      $
                      <CountUp end={11530} redraw={true}>
                        {({ countUpRef, start }) => (
                          <VisibilitySensor onChange={start} delayedCall>
                            <span ref={countUpRef} />
                          </VisibilitySensor>
                    ...
                    <p className="leading-relaxed">Dollars Raised</p>
                  </div>
                </div>
              </div>
            </section>
    ...
    justifyContent: 'center'}}>
      ...
      <FeaturesTiles invertMobile topDivider imageFill className="test"/>
      <Partners invertMobile topDivider imageFill className="test"/>
      <FeaturesSplit invertMobile topDivider imageFill className="illustration-section-02" />
      <CurrentDrives invertMobile topDivider imageFill/>
      <Cta split />
      <Contact />
    </>
  );
